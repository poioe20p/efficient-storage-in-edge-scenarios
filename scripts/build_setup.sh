...
# ==============================
# 2 - Create OVS bridge and veth pairs
# =============================
...
docker run -dit --name container1 --network none ubuntu-host-1
...
PID_MONGO=$(docker inspect -f '{{.State.Pid}}' mongodb)
...
# ==============================
# Step 9: Configure host side of WAN link
echo "Configuring host side of WAN link..."
# ==============================
