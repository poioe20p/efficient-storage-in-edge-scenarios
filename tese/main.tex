...
research, contextualised for resource orchestration in edge platforms. 
The review is organised around the field areas of
...
the demand-driven slice of orchestration.
...
but not generally claimed nor systematically studied.
...
containerisation, and NoSQL and MongoDB as the chosen storage tier,
each introduced for what it is and why it suits the edge scenario.
...
data is produced and consumed which brings benefits but also challenges with management relevance being one of them, as presented in \ref{sec:context_motivation}.

    The platforms that materialise this paradigm have been characterized by
...
\end{table}
    ...
    Within the reviewed corpus, therefore, the building blocks of the
