...
under varying demand shifts. 

    The investigation rests on the idea that
running telemetry consumption, scaling decisions, and routing within each
...
delivery of demand evidence, the scaling action
selected, or the admission of ready capacity while keeping the others
...
\begin{itemize}
    ...
    targeted-tier relief, service recovery, and resource efficiency?
    ...
    routable and usable capacity, and what does the faster mechanism lose
    when its readiness notification is lost and spare capacity is scarce?
\end{itemize}
...
In \ac{DSRM} the research is organized into six sections: problem
