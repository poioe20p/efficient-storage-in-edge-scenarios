...
delegated to decentralized microservices reached through an API,
...
decentralized microservices reached through an API, omitting scaling
altogether
...
uses ZMQ for communication among its distributed components,
