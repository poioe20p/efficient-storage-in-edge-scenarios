...
and applications to users by leveraging it's geo-distributed nature for deployment. 
...
apparatus, which lets each interface be varied in isolation while the others are held
constant, and its impact on the time from demand to usable capacity measured across
