...
control point is an approach established in the literature 
and leveraged in this dissertation. Neither system, however, reports the
delay attributable to its coordination.
...
The time taken by the state updates, exchanges, 
and redirects along those communication paths is not
attributed to the individual handoffs
between observing demand, deciding, and admitting capacity.
