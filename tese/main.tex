...
running service, known as resource orchestration, is also reviewed and alongside the
...
matters for the thesis scenario. How the building blocks are applied
...
cloud: latency-sensitive processing is shifted to the edge,
...
alone cannot serve every workload well, and bringing computation
closer to the user lowers the latency of
interactive and data-intensive services, and processing data locally
relieves the bandwidth pressure on the core
...
evaluated in this dissertation runs in this environment: a stateful
edge service whose capacity must follow fluctuating demand, which is
the management problem the remainder of this chapter reviews.
