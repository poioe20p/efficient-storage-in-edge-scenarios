...
- Primary metrics: per-phase failures and p95 latency from generated request
  ...
  `tier1_reporting_count` trends from `resource_stats.csv` (`tier1_reporting_count`
  remains a deprecated compatibility alias); container lifecycle
...
- Batch 5 `20260510_150147_batch5_normal_combined` completed the combined row.
  ...
  `tier1_reporting_count` stayed at 0.0 in resource telemetry. Compared with
