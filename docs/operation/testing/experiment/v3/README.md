...
| [`rq3_low_headroom/`](rq3_low_headroom/) | RQ3 readiness-admission low-headroom consequence follow-up: quota screens, fixed-window transient QoE, and separate event-source-absence robustness | **preparation implemented — NOT launched** |
