...
The 2-run preflight planned in `run_matrix_storage_closed.md` §3 was expanded to **4 runs**
...
- **Code pinned:** tag `rq3-stor-v3-campaign-20260807` (launch code force-added
  ...
  launch with hash verification, hashes recorded in `v3/rq3/run_matrix_storage_closed.md`).
- **Preflight gate:** 2 runs (P1 direct + P2 disc, seed 3001) must pass
  ...
  campaign gates G5/G7) before the campaign launches — `run_matrix_storage_closed.md` §3.
